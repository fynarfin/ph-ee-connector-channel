...
public class ChannelValidator {
    ...
    public static PhErrorDTO validateTransactionRequest(TransactionChannelRequestDTO request) {
        final ValidatorBuilder validatorBuilder = new ValidatorBuilder();
    ...
    public static PhErrorDTO validateTransaction(GsmaTransfer request) {
        final ValidatorBuilder validatorBuilder = new ValidatorBuilder();
